...
<style lang="less">
@bubbleCorlor:#ff8a00;
@flowMainColor: @color-main;
@flowSubColor: @font-t3;
...
.weui-wepay-flow__state{
  ...
  border :3px solid @flowSubColor;
  .weui-wepay-flow__li_done &{
    background-color: #fff;
    border :3px solid @flowMainColor;
  }
}
...
[class^="weui-wepay-flow__info-"]{
  .setBubbleCommon(14px,@flowMainColor,10px,#FFF,2px);
  position: absolute;
...
.weui-wepay-flow__info-top{
  ...
  .setBubblePrivate(top,@flowMainColor);
}
.weui-wepay-flow__info-bottom{
  ...
  .setBubblePrivate(bottom,@flowMainColor);
}
.weui-wepay-flow__info-left{
  ...
  .setBubblePrivate(left,@flowMainColor);
}
.weui-wepay-flow__info-right{
  ...
  .setBubblePrivate(right,@flowMainColor);
}
.weui-wepay-flow__line{
  flex:1;
  background-color: @flowSubColor;
  height: 3px;
  position: relative;
  margin-left: 5px;
}
...
.weui-wepay-flow__process{
  display: none;
  background-color: @flowMainColor;
  height: 3px;
  position: relative;
  .weui-wepay-flow__line_ing &{
    display: block;
