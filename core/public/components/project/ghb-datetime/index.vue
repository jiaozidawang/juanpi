<!-- 废弃，将在之后删除这个组件，请使用showDatePicker这个JSAPI代替 -->
<!-- 废弃，将在之后删除这个组件，请使用showDatePicker这个JSAPI代替 -->
<!-- 废弃，将在之后删除这个组件，请使用showDatePicker这个JSAPI代替 -->
<!-- 废弃，将在之后删除这个组件，请使用showDatePicker这个JSAPI代替 -->
<!-- 废弃，将在之后删除这个组件，请使用showDatePicker这个JSAPI代替 -->
...
<script>
import Icon from '@comp/base/v-icon'
import Picker from './datetimepicker'
import Group from '@comp/base/group'
import InlineDesc from '@comp/base/inline-desc'
import Uuid from '@comp/vux-support/mixins/uuid'
import format from '@comp/vux-support/tools/date/format'
